<div id="layoutSidenav_nav">
    <nav class="sb-sidenav accordion sb-sidenav-dark me-4" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav mt-2">
                ...
                @endif
                @if(getPermissions(auth()->user()->role_id,'received.items'))
                    <a class="nav-link" href="{{ route('received.items') }}">
                        <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                        Received Items
                    </a>
                @endif
