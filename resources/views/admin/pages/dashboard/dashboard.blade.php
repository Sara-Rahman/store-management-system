...
<div class="container" style="display: grid; margin-left: -15px;">
    <div class="row" style="height: 90px;">
        <div class="col-md-3 card-body" style="padding:3px;"><a class="btn btn-success size"
    ...
    <div class="row" style="height: 90px;">
        ...
        <div class="col-md-4 card-body" style="padding:3px;"><a class="btn btn-success size"
                href="{{route('executive.index')}}"><i style="font-size: 30px;" class="fa-solid fa-id-badge"></i>
                Store Executive</a></div>
        <div class="col-md-4 card-body" style="padding:3px;"><a class="btn btn-success size"
                href="{{route('supplier.index')}}"><i style="font-size: 30px;" class="fa-solid fa-id-badge"></i> Supplier</a></div>
        <div class="col-md-4 card-body" style="padding:3px;"><a class="btn btn-success size" href="{{route('role.index')}}"><i style="font-size:30px" class="fa-solid fa-people-arrows-left-right"></i>
                Roles</a></div>
