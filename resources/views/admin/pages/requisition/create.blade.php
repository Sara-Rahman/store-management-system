            ...
            <table class="table">
                ...
                <tbody>
                  <tr>
                   ...
                   <td class="col-4"><input type="number" name="quantity[]" class="form-control" placeholder="Enter Quantity" value=""/></td>
                   <td class="col-4">
